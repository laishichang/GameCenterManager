...
- (IBAction)reportScore {
    [[GameCenterManager sharedManager] saveAndReportScore:[[GameCenterManager sharedManager] highScoreForLeaderboard:@"grp.GameCenterManager.PlayerScores"]+1
                                              leaderboard:@"grp.GameCenterManager.PlayerScores"
